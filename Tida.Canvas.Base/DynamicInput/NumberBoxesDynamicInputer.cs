using Tida.Canvas.Base.NativePresentation;
...
namespace Tida.Canvas.Base.DynamicInput {
    ...
    public partial class NumberBoxesDynamicInputer :
        ...
        /// 输入框容器;
        /// </summary>
        private readonly INumberBoxContainer _numberBoxContainer = NumberBoxService.CreateINumberBoxContainer();
    ...
    public partial class NumberBoxesDynamicInputer {
        ...
        private static INumberBox GetNumberBoxByNumberBoxInteractionHandler(NumberBoxInteractionHandler numberBoxInteractionHandler) {

            if (numberBoxInteractionHandler == null) {
                throw new ArgumentNullException(nameof(numberBoxInteractionHandler));
            }

            var numberBox = NumberBoxService.CreateNumberBox();
