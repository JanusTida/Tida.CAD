...
namespace Tida.Canvas.Base.NativePresentation.Views {
    /// <summary>
    ...
    public partial class NumberBoxContainer : ContentControl, INumberBoxContainer {
        public NumberBoxContainer() {
            ...
            if (WPFApplication.Current.MainWindow != null) {
                TextCompositionManager.AddPreviewTextInputHandler(WPFApplication.Current.MainWindow, MainWindow_PreviewTextInput);
            }
        ...
        public void Dispose() {
            if (WPFApplication.Current.MainWindow != null) {
                TextCompositionManager.RemovePreviewTextInputHandler(WPFApplication.Current.MainWindow, MainWindow_PreviewTextInput);
            }
        }
