using Tida.Canvas.Base.Dialogs;
...
namespace Tida.Canvas.Base.EditTools {
    ...
    public partial class OffsetEditTool :  EditTool {
        public OffsetEditTool() {
            _numberBoxContainer = NumberBoxService.CreateINumberBoxContainer();
        ...
        protected void BuildClickedCellOffsetWithMousePosition(Vector2D clickedPosition) {
            ...
            if (clickedObjectCount == 1) {
                ...
                originDrawObject = DrawObjectSelectDialog.SelectOneDrawObject(clickedObjects);
            }
