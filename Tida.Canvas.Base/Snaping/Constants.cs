namespace Tida.Canvas.Base.Snaping {
    public static class Constants {
        public const int SnapRuleOrder_DoubleDrawObjectIntersect = 2048;

        public const int SnapRuleOrder_AxisTracking = 1024;

        public const int SnapRuleOrder_GridSnap = 1020;

        public const int SnapRuleOrder_LineAndRound = 512;

        public const int SnapRuleOrder_LineSnap = 510;
